...
/// Manifest of configured LSP servers, keyed by a canonical language id.
...
/// Map a file extension to a canonical language id.
...
/// Helper: build a `file://` URI or a clear error.
